...
Current latest release: [v2.0.3](https://github.com/timbornemann/Open-Git-Control/releases/tag/v2.0.3), published 2026-07-24.
...
| Linux amd64 | Debian package `.deb` | [Open-Git-Control-2.0.3-linux-amd64.deb](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.3/Open-Git-Control-2.0.3-linux-amd64.deb) |
...
| macOS x64 | Zip archive | [Open-Git-Control-2.0.3-mac-x64.zip](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.3/Open-Git-Control-2.0.3-mac-x64.zip) |

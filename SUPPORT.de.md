...
## Wo du fragen oder melden kannst

- Bug Report: Nutze das Bug-Report-Formular, wenn etwas nicht wie erwartet funktioniert.
...
## Gute Meldungen helfen

Bitte gib App-Version, Betriebssystem, Git-Version, Installationsart, Reproduktionsschritte, erwartetes Verhalten, tatsaechliches Verhalten und bei Bedarf Screenshots oder Logs an.

Bei Fragen und Feature Requests ist der Workflow, den du erreichen moechtest, oft hilfreicher als nur die Beschreibung eines Buttons oder Screens.

## Maintainer-Erwartungen

Dies ist ein Open-Source-Projekt mit begrenzter Maintainer-Zeit. Klare Meldungen, kleine Pull Requests und reproduzierbare Beispiele machen Hilfe deutlich leichter.

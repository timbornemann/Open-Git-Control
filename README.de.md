...
Aktuell neuestes Release: [v2.0.4](https://github.com/timbornemann/Open-Git-Control/releases/tag/v2.0.4), veroeffentlicht am 2026-07-25.
...
| Linux amd64 | Debian-Paket `.deb`   | [Open-Git-Control-2.0.4-linux-amd64.deb](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.4/Open-Git-Control-2.0.4-linux-amd64.deb)             |
...
| macOS x64   | Zip-Archiv            | [Open-Git-Control-2.0.4-mac-x64.zip](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.4/Open-Git-Control-2.0.4-mac-x64.zip)                     |

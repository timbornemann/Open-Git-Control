...
const isRegressiveState = (current: GitCommit['statsState'], next: GitCommit['statsState']): boolean => {
...
export const mergeCommitStatsUpdate = (commit: GitCommit, update: CommitStatsUpdate): GitCommit => {

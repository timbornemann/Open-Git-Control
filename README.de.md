...
Aktuell neuestes Release: [v2.0.1](https://github.com/timbornemann/Open-Git-Control/releases/tag/v2.0.1), veroeffentlicht am 2026-07-16.
...
| --- | --- | --- |
| Windows x64 | NSIS Installer `.exe` | [Open-Git-Control-2.0.1-win-x64.exe](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.1/Open-Git-Control-2.0.1-win-x64.exe) |
| Linux x64 | AppImage | [Open-Git-Control-2.0.1-linux-x86_64.AppImage](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.1/Open-Git-Control-2.0.1-linux-x86_64.AppImage) |
| Linux amd64 | Debian-Paket `.deb` | [Open-Git-Control-2.0.1-linux-amd64.deb](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.1/Open-Git-Control-2.0.1-linux-amd64.deb) |
| macOS x64 | Disk Image `.dmg` | [Open-Git-Control-2.0.1-mac-x64.dmg](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.1/Open-Git-Control-2.0.1-mac-x64.dmg) |
| macOS x64 | Zip-Archiv | [Open-Git-Control-2.0.1-mac-x64.zip](https://github.com/timbornemann/Open-Git-Control/releases/download/v2.0.1/Open-Git-Control-2.0.1-mac-x64.zip) |

...
export function filterCommitsForReleaseNotes(
...
export function buildReleaseNotesPromptHints(
  options: ReleaseNotesOptions,
  language: 'de' | 'en',
): string[] {
  const hints: string[] = [];
...
export function buildAlgorithmicChangeListMarkdown(
  commits: ReleaseCommitDto[],
  language: 'de' | 'en',

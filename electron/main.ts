...
import {
  ...
  normalizeArgs,
  validateCommandArgs,
} from './main-process/gitCommandPolicy';
import {
  parseFileBlame,
  parseFileHistory,
  parseReleaseCommits,
  parseStashList,
} from './main-process/parsing';
import { readStoreData, writeStoreData, type StoredData } from './main-process/repoStore';
import {
...
} from './main-process/secureStore';
import {
  getGeminiApiKeyFromSecureStore,
  readSettingsWithMigration,
  writeSettings,
} from './main-process/settingsStore';
import { runGithubCliOneClickLogin } from './main-process/githubCliAuth';
